...
==============================================================================*/
Grant Execute On dbo.SearchStudents     To SuperManagerRole;
Grant Execute On dbo.SearchManagers     To SuperManagerRole;
Grant Execute On dbo.SearchInstructors  To SuperManagerRole;
Grant Execute On dbo.SearchBranches     To SuperManagerRole;
...
GRANT EXECUTE ON dbo.assignStudentToCourse TO SuperManagerRole, BranchManagerRole;
...
GRANT EXECUTE ON dbo.SP_ShowCourceExams               TO InstructorRole;
