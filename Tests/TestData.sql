...
EXEC addManagerUser
    @UserName = 'ahmedOsman',@Password = 'Password123',@FName = 'ahmed',@LName = 'Othman',
...
EXEC addManagerUser
    @UserName = 'sara_mahmoud',@Password = 'Password123',@FName = 'Sara',
...
EXEC addManagerUser
    @UserName = 'ahmed_sayed',@Password = 'Password123',@FName = 'Ahmed',
...
--========================================================================================================
--==============================login as supermanger============================================
--========================================================================================================

/*--=====================================================================================================================
--2)SuperManger login to the sql server and use the ITI_Project database he will be able to :
--=======================================================================================================================*/
/*====>[1]- Execute the stored procedure called updateManagerUser which update his details or update any other branch manger details such as
...
/*====>[]- Execute the stored procedure called addBranch to Add new ITI branch */
...
/*====>[3]- Execute updateBranch Stored procedure to update details of ITI branch Branch 
...
EXEC UpdateInstructorUser @InstructorID = 13, @PhoneNumber = '010000001010'  --new phone number
...
EXEC SearchStudents @StudentID = 6;
EXEC SearchStudents @StudentName = 'Ali';
EXEC SearchStudents @DepartmentID = 1
EXEC SearchStudents @DepartmentID = 2, @IntakeID = 2025;
...
EXEC SearchInstructors; -- all instructors
EXEC SearchInstructors @InstructorID = 13;
EXEC SearchInstructors @InstructorName = 'sara';
EXEC SearchInstructors @DepartmentID = 1;
EXEC SearchInstructors @BranchID = 100,@DepartmentID = 1;

/*====>[D]- SearchBranches current manger branch -intakes and tracks   */
EXEC SearchBranches; -- all branches
EXEC SearchBranches @BranchID = 100 , @TrackID=1;
/*--=====================================================================================================================
--3)Any Instructor login to the sql server and use the ITI_Project database he will be able to :
--=======================================================================================================================*/
/*===================================================================================================================
====> [1]--Execute the stored procedure called  ShowCurrentInstructorCourses to show  current instructor course
=====================================================================================================================*/
EXEC ShowCurrentInstructorCourses

--====> [2]--Execute the stored procedure called sp_addMCQQuestion to add MCQ Question to specific course he teaches.*/
...
--===========================================================================================================================
--====> [3]--Execute the stored procedure called sp_addTFQuestion to add TF Question to specific course he teaches.*/
--===========================================================================================================================
...
--===========================================================================================================================
--====> [4]--Execute the stored procedure called sp_addTextQuestion to add Text Question to specific course he teach.*/
--===========================================================================================================================
...
--===========================================================================================================================
--====> [5]--Execute the stored procedure called sp_updateQuestion to add update Question in a specific course he teaches.*/
--===========================================================================================================================
...
--===========================================================================================================================
--====> [6]--Execute the stored procedure called  sp_deleteQuestion to delete a question in a specific course he teaches.*/
--===========================================================================================================================
EXEC sp_addTextQuestion @QuestionText = 'Explain the difference between INNER JOIN, LEFT JOIN', @CourseID = 101,
    @BestTextAnswer = 'INNER JOIN returns matching rows, LEFT JOIN all left rows with matching right, RIGHT JOIN all right rows with matching left, FULL OUTER JOIN all rows from both tables.';
Exec sp_deleteQuestion 31
...
/*===========================================================================================================================
====> [7]--Execute the stored procedure called  sp_createRandomExam to generate an exam automatically/randomly 
in a specific course he teaches with specific structure.
--===========================================================================================================================*/
EXEC sp_createRandomExam  @ExamID = 1001, @ExamType = 'Exam', @BIT_ID = 7, @Duration = 60, @No_Of_MCQ = 5,@No_Of_TextQ = 3,@No_Of_TFQ = 2,
    @MaxGrade = 100, @AllowanceOptions = 'None',@CourseID = 101,@MinGrade = 50;
GO
EXEC sp_createRandomExam  @ExamID = 1002, @ExamType = 'Exam',@BIT_ID = 7,@Duration = 12 ,@No_Of_MCQ = 8,@No_Of_TextQ = 4,@No_Of_TFQ = 3,
    @MaxGrade = 150,@AllowanceOptions = 'Calculator Allowed', @CourseID = 101, @MinGrade = 60;

/*===========================================================================================================================
====> [8]--Execute the stored procedure called  sp_createManualExam to create an exam manuallyfor a specific course he teaches.
--===========================================================================================================================*/
...
Exec sp_deleteExam 1004

Exec [dbo].[SP_ShowCourceExams] 101
...
/*--=====================================================================================================================
--Student login to the sql server and use the ITI_Project database he will be able to :
--=======================================================================================================================*/
--student selects from vw_CurrentStudentExamQuestions view to show his exam questions 

select * from  dbo.vw_CurrentStudentExamQuestions

/*===================================================================================================================
====> -- Execute the stored procedure called sp_StudentAnswerQuestion to answer the given exam question*/
...
Exec sp_StudentAnswerQuestion 24 , 'Primary key uniquely identifies rows and cannot be null, unique key' 
Exec sp_StudentAnswerQuestion 27 , 'stored procedure is a precomiled'

/*--=====================================================================================================================
--instructor login to the sql server to correct exams :
--=======================================================================================================================*/

-- Example 3: Instructor views the answers for student with id 6 in Exam 1001
EXEC sp_ViewStudentAnswers @StudentID = 6, @ExamID = 1001
	
 /*===========================================================================================================================
====> [1]--Instructor shows asswers of student with id =6 on courseid = 101
--===========================================================================================================================*/
--  Instructor wants to show only Text answers for Student 6 in Course 101
EXEC sp_ViewStudentAnswers @StudentID = 6, @CourseID = 101, @QuestionType = 'Text';

--Execute the stored procedure called  sp_CorrectExamManually to correct text valid questions manually
EXEC sp_CorrectExamManually @StudentID = 6, @ExamID = 1001, @QuestionID = 22, @Grade = 8.00, @IsValid = 1;
EXEC sp_CorrectExamManually @StudentID = 6, @ExamID = 1001, @QuestionID = 24, @Grade = 8.00, @IsValid = 1;
EXEC sp_CorrectExamManually @StudentID = 6, @ExamID = 1001, @QuestionID = 27, @Grade = 8.00, @IsValid = 1;


 /*===========================================================================================================================
====> [2]--Execute the stored procedure called  sp_UpdateExamTotalGrade to update Exam total grade and course grade 
--===========================================================================================================================*/
